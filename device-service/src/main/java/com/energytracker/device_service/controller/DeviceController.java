...
import com.energytracker.device_service.service.IDeviceService;
...
public class DeviceController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DeviceDto> updateDevice(@PathVariable("id") Long id, @RequestBody DeviceDto deviceDto){
